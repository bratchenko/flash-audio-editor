package ru.inspirit.net
{
	...
	public class MultipartURLLoader extends EventDispatcher
	{
		 ...
		 */
		public function addFile(fileContent:ByteArray, fileName:String,
		                        dataField:String = 'Filedata',
		                        contentType:String = 'application/octet-stream'):void
		{
		...
		private function getFilePartHeader(postData:ByteArray,
		                                   part:FilePart):ByteArray
		{
			var i:uint;
			var bytes:String;
		...
		private function getFilePartData(postData:ByteArray,
		                                 part:FilePart):ByteArray
		{
		...
		private function writeChunkLoop(dest:ByteArray, data:ByteArray,
		                                p:uint = 0):void
		{
...
internal class FilePart
{
	...
	public function FilePart(fileContent:flash.utils.ByteArray, fileName:String,
	                         dataField:String = 'Filedata',
